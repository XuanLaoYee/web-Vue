        ...
        <el-container>
            ...
            <el-footer>
                <div class="footer">
                    ...
                    <div class="github">
                        <a href="https://github.com/XuanLaoYee/web-Vue/tree/master/web" target="_blank">
    ...
    export default {
        ...
        data() {
            return {
                ...
                visible: false//是否退出登陆
            };
        },
        created() {
            if (localStorage.getItem("user")) {//从localStorage中判断是否登陆
                this.setUser(JSON.parse(localStorage.getItem("user")));//如果已经登陆,则设置vuex.store登陆状态
            }
        },
        computed: {
        ...
        watch: {
            getUser: function (val) {//获取vuex的登陆状态
                if (val === "") {//并没有登陆
                    ...
                    this.$axios
                        ...
                        .then(res => {
                            if (res.data.code === "001") {// 001为成功, 更新vuex.store购物车状态
